	...
	<div class="h-screen w-screen flex items-center justify-center">
		...
		<div class="w-[500px] border border-solid p-10 rounded rounded-xl bg-sky-300/50 ">
			<form class="w-full flex flex-col gap-5 items-center justify-center" action="functions/verify.php" method="POST">
				<p class="font-bold text-2xl">Register Form</p>
				<input class="w-full border border-solid p-5 rounded rounded-full" placeholder="Username" type="text" name="username" required>
				<input class="w-full border border-solid p-5 rounded rounded-full" placeholder="Email" type="text" name="email" required> 
				...
				<input class="w-full border border-solid p-5 rounded rounded-full" placeholder="Re-Password" type="password" name="repassword" required>
				<input class="w-full p-5 rounded rounded-full bg-gray-300 hover:bg-gray-400" type="submit" value="Register" name="register">
			</form>
		</div>	
	</div>
